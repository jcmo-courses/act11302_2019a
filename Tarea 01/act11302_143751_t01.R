...
### DE ESTA GRÁFICA PODEMOS CONCLUIR QUE LA FUNCIÓN EXPONENCIAL ES LA ÚNICA QUE CORRE ###
### EXITOSAMENTE CON LOS VALORES QUE DECIDIMOS, LA FUNCIÓN LIKELIHOOD ES LA ÚNICA ###
### QUE CUANDO N ES GRANDE ESTA TIENDE A LA FUNCIÓN EXPONENCIAL TEÓRICA. ###
